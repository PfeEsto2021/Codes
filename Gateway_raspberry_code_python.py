# -*- coding: utf-8 -*-
"""
Created on Tue March 01 09:10:43 2021
...
def operation():
    ...
    while True:
            ...
            jj=0
            for i in tr :
                l[jj]=float(i)          #ajouter les valeur de la liste dans un dictionnaire tandis que le clé de chaque valeur augmente par 1
                jj+=1
            ...
            #envoie à blynk dans la porte virtual 3 la valeur de humidité
